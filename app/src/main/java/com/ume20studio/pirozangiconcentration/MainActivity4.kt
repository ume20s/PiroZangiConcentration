...
class MainActivity4 : AppCompatActivity() {
    ...
    val cardnum: Int = 16               // カード枚数
    val basepoint = 60                  // 基本ポイント
    var score: Int = 0                  // スコア
    ...
    // カードのイメージボタン配列
    val bt = arrayOf(R.id.ImgBtn4_01, R.id.ImgBtn4_02, R.id.ImgBtn4_03, R.id.ImgBtn4_04,
        R.id.ImgBtn4_05, R.id.ImgBtn4_06, R.id.ImgBtn4_07, R.id.ImgBtn4_08,
        R.id.ImgBtn4_09, R.id.ImgBtn4_10, R.id.ImgBtn4_11, R.id.ImgBtn4_12,
        R.id.ImgBtn4_13, R.id.ImgBtn4_14, R.id.ImgBtn4_15, R.id.ImgBtn4_16)
    ...
    // ミスインジケータのグラフィック配列
    val peke = arrayOf(R.id.Miss4_01, R.id.Miss4_02, R.id.Miss4_03,
        R.id.Miss4_04, R.id.Miss4_05, R.id.Miss4_06, R.id.Miss4_07,
        R.id.Miss4_08, R.id.Miss4_09, R.id.Miss4_10 )
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<TextView>(R.id.Combo4).text = combo.toString()
        findViewById<TextView>(R.id.Score4).text = score.toString()
        findViewById<TextView>(R.id.HighScore4).text = highscore.toString()
        ...
        findViewById<ImageButton>(R.id.PlainBase4).setOnClickListener(baseListener)

        // ゲームエンドバナーへのイベントリスナの紐づけ
        val gameendListener = GameEnd()
        findViewById<ImageButton>(R.id.GameEnd4).setOnClickListener(gameendListener)
    }
    ...
    private inner class CardTap : View.OnClickListener {
        override fun onClick(v: View){
            ...
            if(status == 0) {        // 未判定状態だったらカードをオープンする
                ...
                if(cardopen >= cardnum) {
                    mp.stop()
                    findViewById<ImageButton>(R.id.GameEnd4).setImageResource(R.drawable.clear_stage4)
                    findViewById<ImageButton>(R.id.GameEnd4).visibility = View.VISIBLE
                    soundPool.play(omedetou, 1.0f, 1.0f, 0, 0, 1.0f)
                }
                // ミスが１０回になったときの処理
                if(miss >= 10) {
                    mp.stop()
                    findViewById<ImageButton>(R.id.GameEnd4).setImageResource(R.drawable.gameover)
                    findViewById<ImageButton>(R.id.GameEnd4).visibility = View.VISIBLE
